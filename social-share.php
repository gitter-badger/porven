<ul class="social-share">
	...
	<li><a rel="nofollow" class="share-twitter" target="_blank" href="https://twitter.com/intent/tweet?text=<?php the_title() ?>&via=diarioporven&url=<?php bloginfo('url') ?>/n/<?php the_ID() ?>"><i class="icon-twitter" title="Twitter"></i><span>Twittear</span></a></li>
