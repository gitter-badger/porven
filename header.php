		...
		<header id="site-header">
			<a class="site-logo" href="<?php bloginfo('url') ?>">
				<div id="logo-header">
					...
					<time>Rosario, <span><?php setlocale(LC_ALL,"es_ES"); $tildes = array('á', 'é'); $acute = array('&aacute;', '&eacute;'); echo str_replace($tildes, $acute, strftime("%A %e de %B del %Y")); ?></time>
				</div>
				<div id="barras-header">
					<span class="barra-header barra-1">&nbsp;</span>
					<span class="barra-header barra-2">&nbsp;</span>
					<span class="barra-header barra-3">&nbsp;</span>
				</div>
			</a>
			...
			<form>
				<input class="input-search" type="text" placeholder="Buscar noticias o temas" />
