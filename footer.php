<footer id="site-footer"<?php global $post_format; if( $post_format == 'longform' ) { echo ' class="footer-longform"';} // Si es longform agrega una clase y el container ?>>
	...
	<a class="site-logo" href="#">
		...
		<g>
			<g>
				<path fill="#666668" d="M24.895,35.304v8.953c0,2.233,2.693,3.349,8.08,3.349v7.643H0v-7.643c4.318,0,6.479-1.116,6.479-3.349
				...
				<path fill="#666668" d="M111.225,28.17c0,4.416-0.559,8.371-1.674,11.865c-1.117,3.494-2.828,6.455-5.132,8.88
				...
				<path fill="#666668" d="M166.399,55.758c-2.718,0-5.035-0.353-6.952-1.056c-1.917-0.703-3.494-1.649-4.731-2.839
				...
				<path fill="#666668" d="M234.313,8.808c-2.184,0-3.712,0.182-4.586,0.546c-0.873,0.364-1.455,0.886-1.747,1.565l-14.412,44.33
				...
				<path fill="#666668" d="M358.568,8.808c-4.319,0-6.479,1.117-6.479,3.349v43.092h-21.765l-18.197-37.852v26.86
			...
			<path fill="#666668" d="M273.839,10.264c4.609,0,6.915,2.548,6.915,7.643l9.463-0.005V1.165H237.88v7.643
		...
		<path fill="#666668" d="M363.656,55.562c0,0,17.721-56.651,54.616-54.328c0,0-4.576,7.41-16.124,9.805c0,0,5.376,0.656,9.733-0.798
...
<?php if( $post_format == 'longform' ) { echo '</div>';} ?>
	...
	<?php } elseif( $post_format == 'dossier' ) {  ?>
		<script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
